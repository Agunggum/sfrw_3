                ...
                <nav class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <?php if(isset($_SESSION['username'])){ ?>
                            ...
                            <a href="<?php echo site_url('signout'); ?>" class="btn btn-sm btn-outline-danger ms-2 rounded-3"><span id="id-keluar" class="title-class" data-lang-id="id-keluar">Keluar</span></a>
                            <a href="<?php echo site_url('dashboard'); ?>" class="btn btn-sm btn-info ms-2 rounded-3"><span id="id-dasbor" class="title-class" data-lang-id="id-dasbor">Dasbor</span></a>
                        <?php } else { ?>
                            <a href="<?php echo site_url('login'); ?>" class="btn btn-sm btn-danger rounded-3"><span id="id-masuk" class="title-class" data-lang-id="id-masuk">Masuk</span></a>
                        <?php } ?>
...
<script type="module" src="<?php echo asset('bootstrap/theme/js/lit-html/welcome-lit.js?v=0.3'); ?>"></script>
